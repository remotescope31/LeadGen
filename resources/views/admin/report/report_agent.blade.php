...
@section('content')
    ...
    <script>
        ...
        $('body').on('click','#create_excel', function(){
            ...
            var page = "{{url('admin/report_agent_csv')}}?" + $('#report_agent').serialize();
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                url: '{{ url('search_colorclient') }}',
                type: 'get',
                success: function(response){

                    colorclient = response;
                }
            });
    ...
    <div class="container">
        ...
        <input type="text" id="to" name="to">
            ...
            <div id="colorclient">
                <h3>Цвет Клиента</h3>
                <button type="button" value="Add" onclick="javascript:add('colorclient',colorclient);">Add</button>
                <br>
            </div>
